...
Below certificate is used by Azure to call your RP (.cer files).

- [Production\Stage environment](https://github.com/v-shresh/azure-resource-provider-sdk/blob/master/docs/misc/AzureStoreLatest.cer)
